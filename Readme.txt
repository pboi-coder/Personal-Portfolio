...
Overview
This is the personal portfolio website of Param Sharma, built using HTML5 and CSS3 as part of INFR3120 – Web and Scripting Programming (Assignment 1).  
...
Param Sharma**
Email: [param.sharma@ontariotechu.net]
